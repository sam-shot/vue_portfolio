...
<template>
    ...
    <div class="flex sm:flex-row flex-col justify-center gap-4 sm:w-3/4 center mx-auto  ">
        <div :class="{'sm:order-last' : !isLast}" class="p-4 project_bg rounded-xl border border-solid border-gray-700 min-h-40 basis-2/3">
            <img :src="data.image"
        ...
        <div
            ...
            <div class="mb-3">
                ...
                <h2 class="mt-1 font-normal text-sm">{{data.description}}
                </h2>
            </div>
        </div>
    </div>
